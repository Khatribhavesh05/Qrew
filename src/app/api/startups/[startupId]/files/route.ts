...
// ── Template generators (same as download route) ──────────────────────────────
...
// ── Build complete project (same logic as download route) ─────────────────────
...
function buildCompleteProject(
  ...
  // Remove the error-fallback blob file
  ...
  // Remove old .ts config if it exists
